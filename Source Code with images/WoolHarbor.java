...
public class WoolHarbor extends Harbor
{

   public WoolHarbor(Point p, double scale)
   {
      point = p;
      ...
      try
      {
         Image rawImage = ImageIO.read(getClass().getResourceAsStream("/images/pastureTile.png"));
