...
public class OreHarbor extends Harbor
{

   public OreHarbor(Point p, double scale)
   {
      point = p;
      ...
      try
      {
         Image rawImage = ImageIO.read(getClass().getResourceAsStream("/images/mountainTile.png"));
